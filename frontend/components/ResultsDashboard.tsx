  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <h2 className="text-4xl font-bold text-white mb-2">Your Carbon Footprint Analysis</h2>
        <p className="text-slate-400">Here's your personalized sustainability report</p>
      </div>

      {/* Main Footprint Card */}
      <Card className="mb-8 text-center bg-gradient-to-br from-slate-800 to-slate-700 border-2 border-lime-400/30 glow-lime">
        <div className="mb-4">
          <p className="text-lg text-slate-300 mb-2">Your Annual Carbon Footprint</p>
        ...
        <div className={`inline-flex items-center gap-2 px-6 py-3 rounded-full ${
          isBelowAverage ? 'bg-lime-400 text-slate-900' : 'bg-orange-500 text-white'
        } font-medium`}>
        ...
        <Card title="What-If Scenario" subtitle="Potential impact of changes">
          <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-xl p-6 mb-6 border border-lime-400/30">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="text-lg font-bold text-white">{results.simulation.scenario}</h4>
            </div>
            
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-slate-300">Current Footprint:</span>
                <span className="text-xl font-bold text-white">{results.totalFootprint.toFixed(1)} tons</span>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-xl font-bold text-lime-400">{results.simulation.newFootprint.toFixed(1)} tons</span>
              </div>
              
              <div className="pt-4 border-t border-lime-400/30">
                <div className="flex items-center justify-between">
                  <span className="text-slate-300 font-medium">Annual Savings:</span>
          ...
          <p className="text-sm text-slate-400 text-center">
            🌱 That's equivalent to planting <strong className="text-lime-400">{Math.ceil(results.simulation.savings / 0.06)}</strong> trees!
          </p>
        </Card>
      </div>
      ...
      <div className="mt-8 text-center p-6 bg-slate-800 rounded-xl border border-lime-400/30">
        <p className="text-white mb-2">
          <strong className="text-lime-400">Great job on taking the first step!</strong>
        </p>
